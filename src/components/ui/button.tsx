...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_8px_30px_rgba(255,255,255,0.08)]',
        destructive: 'bg-destructive text-destructive-foreground hover:bg-destructive/[0.90]',
        ...
        cohora: 'bg-foreground text-background hover:bg-white/[0.88] shadow-[0_12px_40px_rgba(255,255,255,0.14)]',
      },
      size: {
